...
update emp
set comm_pct = null # 변경 : is null을 사용안함.
where dept_id = 100
...
update emp
set comm_pct = 0.2, salary = salary + 3000, mgr_id = 100 where dept_id = 100;


--  IT 부서의 직원들의 급여를 3배 인상
update emp
set salary = salary * 3 where dept_id in (select * from emp where dept_id = 'IT')
